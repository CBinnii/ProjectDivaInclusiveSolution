			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/Slider-1.jpg" class="only-desktop">
						...
						<div class="overlay-slider">
							...
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/slider-1-mobile.png" class="only-mobile">

							<h6 class="subtitle container">Diagnósticos, métricas e tendências em Diversidade.</h6>
						</div>
					</div>
					<div class="swiper-slide">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/Slider-2.jpg" class="only-desktop">
					...
					<div class="swiper-slide escuro" style="color: #253825; background-color: #e05555;">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/Slider-3.jpg" class="only-desktop">
					...
					<div class="swiper-slide header-escuro" style="color: #253825;">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/Slider-5.jpg" class="only-desktop">
			...
			<div class="home-edicao">
				<div class="container">
					<div class="row m-0 justify-content-center">
						...
						<img class="pt-196 pb-196" src="<?php echo get_stylesheet_directory_uri(); ?>/images/home.png">
					...
					<div class="swiper-slide">
						<div class="row h-100">
							<div class="col-lg-6 left">
								...
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/photo-pesquisa.jpg" alt="Journal">

								<a href="#" title="" class="btn-leia-mais">entenda o assunto ></a>
							</div>
							<div class="col-lg-6 right" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/photo-pesquisa.jpg')"></div>
						</div>
					</div>
					<div class="swiper-slide">
						<div class="row h-100">
							<div class="col-lg-6 left">
								...
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/journal.png" alt="Journal">

								<a href="#" title="" class="btn-leia-mais">entenda o assunto ></a>
							</div>
							<div class="col-lg-6 right" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/journal.png')"></div>
						</div>
					</div>
				</div>
				<!-- Add Arrows -->
